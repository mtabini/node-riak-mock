...
Bucket.prototype.setObject = function setBucketObject(key, meta, contentType, contents, links, indices) {
    var object = RiakObject.set(this, key, meta, contentType, contents, links, indices);
...
Bucket.prototype.allObjects = function allObjects() {
    var result = [];
